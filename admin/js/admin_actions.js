            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(res.hasOwnProperty('success')){
                        ...
                        $('#adminLogin').append('<div class="alert alert-danger">Username And Password Are Not Matched.</div>');
                    }
                }
            });
        }
        ...
        if(oldPass == '' || newPass == ''){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = JSON.parse(response);
                    if(res.hasOwnProperty('success')){
                        $('#changePassword').prepend('<div class="alert alert-success">Password Has Been Changed Successfully.</div>');
                        setTimeout(function(){ window.location = URL+'admin/dashboard.php'; }, 1000);
                    }else if(res.hasOwnProperty('error')){
        ...
        if(title == ''){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#createProduct').prepend('<div class="alert alert-success">Product Has Been Added Successfully.</div>');
        ...
        if(title == ''){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#updateProduct').prepend('<div class="alert alert-success">Product Has Been Updated Successfully</div>');
                        setTimeout(function(){ window.location = URL+'admin/products.php'; }, 1000);
        ...
        if(cat == ''){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#createCategory').prepend('<div class="alert alert-success">Category Has Been Added Successfully</div>');
        ...
        if(title == ''){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#updateSubCategory').prepend('<div class="alert alert-success">Sub Category Has Been Modified Successfully</div>');
                        setTimeout(function(){ window.location = URL+'admin/sub_category.php'; }, 1000);
        ...
        if(title == ''){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#createBrand').prepend('<div class="alert alert-success">Brand Has Been Added Successfully</div>');
        ...
        if(title == ''){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#updateBrand').prepend('<div class="alert alert-success">Brand Has Been Modified Successfully.</div>');
                        setTimeout(function(){ window.location = URL+'admin/brands.php'; }, 1000);
        ...
        if(site_name == ''){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#updateOptions').prepend('<div class="alert alert-success">Options Have Been Updated Successfully.</div>');
