        ...
        <form id="createProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
            <div class="col-md-9">
                ...
                <div class="form-group sub_category">
                    ...
                    <?php
                    $db = new Database();
                    $db->select('sub_categories','sub_categories.sub_cat_id,sub_categories.sub_cat_title,sub_categories.cat_parent,sub_categories.show_in_header,sub_categories.show_in_footer,categories.cat_title','categories ON sub_categories.cat_parent=categories.cat_id',null,'sub_categories.sub_cat_id DESC',null);
                    ...
                    <select class="form-control product_sub_category" name="product_sub_cat">
                        ...
                        <?php if ($sub_categories > 0) {  
                            ...
                            <option value="<?php echo $sub_category['sub_cat_id']; ?>"><?php echo $sub_category['sub_cat_title']; ?></option>
                            <?php } 
                            } ?>
                    </select>
                </div>
                ...
                <div class="form-group brand">
                    ...
                    <?php
                    $db = new Database();
                    $db->select('brands','brands.brand_id,brands.brand_title,brands.brand_cat,categories.cat_title','categories ON brands.brand_cat=categories.cat_id',null,'brands.brand_id DESC',null);
                    $brands = $db->getResult();?>
                    <select class="form-control product_brands" name="product_brand">
                        <option value="" selected disabled>Select Brands if available</option>
                        <?php if ($brands > 0) {  
