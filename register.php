        ...
        <div class="col-md-offset-3 col-md-6">
            ...
            <form id="register_sign_up" class="signup_form" method ="POST" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" class="form-control user_name" placeholder="Username Required" requried />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" name="email" class="form-control email" placeholder="Email" requried />
                </div>
                <div class="form-group">
                    <label>Mobile</label>
